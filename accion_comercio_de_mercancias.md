...
| CÓDIGO Producto | Precio base de COMPRA por UCN | Precio base de VENTA por UCN | Días hasta que un MUNDO vuelve a producir ese producto | Días hasta que un MUNDO vuelve a necesitarlo | Ganancia base |
| --- | --- | --- | --- | --- | --- |
