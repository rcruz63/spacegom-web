...
5. **Base de Datos**
   - Hay que volver a recrear la base de datos cuando cambiamos de entorno de desarrollo
...
- Seguir jugando segun el libro.

### Ideas futuras
- Gestión de Partidas.
- Utilizar AWS como soporte del juego. Publicar el frontal, utilizar DynamoDB en lugar de SQLite, ¿lambdas? ¿contenedores?
- Distintos jugadores.
